...
import com.smile.u2b.fragments.SearchVideosFragment
import com.smile.u2b.fragments.U2bFavFragment
import com.smile.u2b.fragments.U2bFragment
import com.smile.u2b.models.U2bSingleton

@OptIn(UnstableApi::class)
open class U2bActivity : BaseActivity() {

    companion object {
        private const val SEARCH_FRAGMENT_TAG : String = "SEARCH_VIDEOS"
        private const val U2B_FAV_FRAGMENT_TAG : String = "U2B_FAVORITE"
    }
    private var mTAG : String = "U2bActivity"
    ...
    override fun askPermissions(activity: Activity): Boolean {
        ...
        return PermissionUtil.askPermissions(this@U2bActivity,
            false)
    }
