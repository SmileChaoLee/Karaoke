...
/* package */ final class ExperimentalFfmpegVideoDecoder
    ...
    public ExperimentalFfmpegVideoDecoder(
        ...
        Log.d(TAG, "ExperimentalFfmpegVideoDecoder");
        if (!FfmpegLibrary.isAvailable()) {
            throw new FfmpegDecoderException("Failed to load decoder native library.");
        }
        checkNotNull(format.sampleMimeType);
        String mimeType = FfmpegLibrary.getCodecName(format.sampleMimeType);
        Log.d(TAG, "ExperimentalFfmpegVideoDecoder.mimeType = " + mimeType);
        codecName = Assertions.checkNotNull(mimeType);
