...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--libdir=android-libs/x86_64 --arch=x86_64 --cpu=x86-64 --cross-prefix=/home/chaolee/Android/Sdk/ndk/26.3.11579264/toolchains/llvm/prebuilt/linux-x86_64/bin/x86_64-linux-android23- --nm=/home/chaolee/Android/Sdk/ndk/26.3.11579264/toolchains/llvm/prebuilt/linux-x86_64/bin/llvm-nm --ar=/home/chaolee/Android/Sdk/ndk/26.3.11579264/toolchains/llvm/prebuilt/linux-x86_64/bin/llvm-ar --ranlib=/home/chaolee/Android/Sdk/ndk/26.3.11579264/toolchains/llvm/prebuilt/linux-x86_64/bin/llvm-ranlib --strip=/home/chaolee/Android/Sdk/ndk/26.3.11579264/toolchains/llvm/prebuilt/linux-x86_64/bin/llvm-strip --disable-asm --target-os=android --enable-static --disable-shared --disable-doc --disable-programs --disable-everything --disable-v4l2-m2m --disable-vulkan --disable-symver --enable-avdevice --enable-postproc --enable-avfilter --enable-swresample --enable-avcodec --enable-avformat --enable-swscale --enable-gpl --enable-decoder=mpegvideo --enable-decoder=mpeg1video --enable-decoder=mpeg2video --enable-decoder=msmpeg4v1 --enable-decoder=msmpeg4v2 --enable-decoder=msmpeg4 --enable-decoder=mpeg4 --enable-decoder=flv --enable-protocol=file --enable-parser='mpegvideo,mpeg4video' --enable-demuxer='mpeg,mpegts,mpegps,vob,avi,mp4,mov' --enable-muxer='mpeg,mpegts,vob,avi,mp4' --enable-decoder=h264 --enable-decoder=hevc --extra-ldexeflags=-pie --enable-decoder=vorbis --enable-decoder=opus --enable-decoder=flac --enable-decoder=alac --enable-decoder=pcm_mulaw --enable-decoder=pcm_alaw --enable-decoder=aac --enable-decoder=mp3 --enable-decoder=amrnb --enable-decoder=amrwb --enable-decoder=ac3 --enable-decoder=eac3 --enable-decoder=dca --enable-decoder=mlp --enable-decoder=truehd --enable-decoder=h264 --enable-decoder=hevc
prefix=/usr/local
LIBDIR=$(DESTDIR)android-libs/x86_64
SHLIBDIR=$(DESTDIR)android-libs/x86_64
INCDIR=$(DESTDIR)${prefix}/include
BINDIR=$(DESTDIR)${prefix}/bin
DATADIR=$(DESTDIR)${prefix}/share/ffmpeg
DOCDIR=$(DESTDIR)${prefix}/share/doc/ffmpeg
MANDIR=$(DESTDIR)${prefix}/share/man
PKGCONFIGDIR=$(DESTDIR)android-libs/x86_64/pkgconfig
INSTALL_NAME_DIR=
SRC_PATH=.
SRC_LINK=.
...
INTRINSICS=none
EXTERN_PREFIX=
CC=/home/chaolee/Android/Sdk/ndk/26.3.11579264/toolchains/llvm/prebuilt/linux-x86_64/bin/x86_64-linux-android23-clang
CXX=/home/chaolee/Android/Sdk/ndk/26.3.11579264/toolchains/llvm/prebuilt/linux-x86_64/bin/x86_64-linux-android23-g++
AS=/home/chaolee/Android/Sdk/ndk/26.3.11579264/toolchains/llvm/prebuilt/linux-x86_64/bin/x86_64-linux-android23-clang
OBJCC=/home/chaolee/Android/Sdk/ndk/26.3.11579264/toolchains/llvm/prebuilt/linux-x86_64/bin/x86_64-linux-android23-clang
LD=/home/chaolee/Android/Sdk/ndk/26.3.11579264/toolchains/llvm/prebuilt/linux-x86_64/bin/x86_64-linux-android23-clang
DEPCC=/home/chaolee/Android/Sdk/ndk/26.3.11579264/toolchains/llvm/prebuilt/linux-x86_64/bin/x86_64-linux-android23-clang
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=/home/chaolee/Android/Sdk/ndk/26.3.11579264/toolchains/llvm/prebuilt/linux-x86_64/bin/x86_64-linux-android23-clang
DEPASFLAGS= $(CPPFLAGS)
X86ASM=nasm
DEPX86ASM=nasm
DEPX86ASMFLAGS=$(X86ASMFLAGS)
AR=/home/chaolee/Android/Sdk/ndk/26.3.11579264/toolchains/llvm/prebuilt/linux-x86_64/bin/llvm-ar
ARFLAGS=rcD
AR_O=$@
AR_CMD=/home/chaolee/Android/Sdk/ndk/26.3.11579264/toolchains/llvm/prebuilt/linux-x86_64/bin/llvm-ar
NM_CMD=/home/chaolee/Android/Sdk/ndk/26.3.11579264/toolchains/llvm/prebuilt/linux-x86_64/bin/llvm-nm
METALCC=xcrun -sdk macosx metal
METALLIB=xcrun -sdk macosx metallib
RANLIB=/home/chaolee/Android/Sdk/ndk/26.3.11579264/toolchains/llvm/prebuilt/linux-x86_64/bin/llvm-ranlib -D
STRIP=/home/chaolee/Android/Sdk/ndk/26.3.11579264/toolchains/llvm/prebuilt/linux-x86_64/bin/llvm-strip
STRIPTYPE=direct
NVCC=clang
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -Dstrtod=avpriv_strtod -DPIC -DZLIB_CONST
CFLAGS=    -std=c11 -fPIE -fomit-frame-pointer -fPIC -pthread -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -Wno-bool-operation -Wno-char-subscripts -O3 -fno-math-errno -fno-signed-zeros -mstack-alignment=16 -Qunused-arguments -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type
...
LD_PATH=-L
DLLTOOL=
WINDRES=/home/chaolee/Android/Sdk/ndk/26.3.11579264/toolchains/llvm/prebuilt/linux-x86_64/bin/x86_64-linux-android23-windres
DOXYGEN=doxygen
LDFLAGS=   -Wl,--as-needed -Wl,-z,noexecstack -Wl,--warn-common -Wl,-rpath-link=:libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil -Qunused-arguments
