Opus decoder module
The Opus module provides LibopusAudioRenderer, which uses the libopus native library to decode Opus audio.
...
Install CMake
Having followed these steps, gradle will build the module automatically when run on the command line or via Android Studio, using CMake and Ninja to configure and build libopus and the module's JNI wrapper library.
